...
#### 获取公司业绩预告 ####
rs_forecast = bs.query_forecast_report("sh.600000", start_date="2017-07-01", end_date="2022-07-01")
...
#### 结果集输出到csv文件 ####
result_forecast.to_csv("D:\\Research\\dataset\\forecast_report.csv", encoding="gbk", index=False)
